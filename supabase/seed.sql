...
-- Conflicts
INSERT INTO public.global_events (id, type, title, summary, severity, country_id, region, lat, lng, tags, occurred_at, source_url) VALUES
  ('00000000-0000-0000-0001-000000000001', 'conflict', 'Russia-Ukraine War: Ongoing Frontline Activity', 'Active combat operations continue along the eastern front in Donetsk and Zaporizhzhia oblasts. Artillery exchanges reported near Avdiivka sector.', 'critical', 'UA', 'Europe', 48.5, 37.5, ARRAY['war', 'artillery', 'frontline', 'ukraine', 'russia'], now() - interval '2 hours', 'https://www.bbc.com/news/world-europe'),
  ('00000000-0000-0000-0001-000000000002', 'conflict', 'Gaza: Humanitarian Corridor Negotiations', 'International mediators working on ceasefire framework. Hostage negotiations ongoing. Significant civilian displacement continues.', 'critical', 'PS', 'Middle East', 31.4, 34.3, ARRAY['gaza', 'humanitarian', 'ceasefire', 'negotiations'], now() - interval '4 hours', 'https://www.reuters.com/world/middle-east/'),
  ('00000000-0000-0000-0001-000000000003', 'conflict', 'Sudan Civil War: RSF vs SAF Clashes Intensify', 'Rapid Support Forces and Sudanese Armed Forces in continued urban conflict in Khartoum and Darfur region. Humanitarian crisis deepening.', 'critical', 'SD', 'Africa', 15.6, 32.5, ARRAY['sudan', 'civil-war', 'rsf', 'humanitarian'], now() - interval '6 hours', 'https://www.aljazeera.com/africa/'),
  ('00000000-0000-0000-0001-000000000004', 'conflict', 'Myanmar: Resistance Forces Advance in Shan State', 'Three Brotherhood Alliance reports significant territorial gains in northern Shan State. Military junta facing pressure on multiple fronts.', 'high', 'MM', 'Asia', 22.9, 98.5, ARRAY['myanmar', 'junta', 'resistance', 'shan-state'], now() - interval '8 hours', 'https://www.irrawaddy.com/'),
  ('00000000-0000-0000-0001-000000000005', 'conflict', 'South China Sea: Naval Tensions Near Spratly Islands', 'Chinese Coast Guard vessels confront Philippine supply vessels near Second Thomas Shoal. Escalatory incident with water cannon deployment.', 'high', 'CN', 'Asia', 9.7, 115.8, ARRAY['south-china-sea', 'territorial-dispute', 'china', 'philippines', 'naval'], now() - interval '12 hours', 'https://www.reuters.com/world/asia-pacific/'),
  ('00000000-0000-0000-0001-000000000006', 'conflict', 'Yemen: Houthi Red Sea Shipping Attacks Continue', 'Ansar Allah (Houthis) launch drone and missile attacks on commercial shipping in Red Sea corridor. Coalition naval forces respond.', 'high', 'YE', 'Middle East', 15.5, 43.2, ARRAY['houthis', 'red-sea', 'shipping', 'attacks', 'iran'], now() - interval '3 hours', 'https://gcaptain.com/'),
  ('00000000-0000-0000-0001-000000000007', 'conflict', 'Ethiopia: Amhara Region Conflict Flares', 'Amhara Fano militias clash with federal forces in Lalibela region. Displacement of civilians reported. Peace process stalled.', 'moderate', 'ET', 'Africa', 12.0, 39.0, ARRAY['ethiopia', 'amhara', 'fano', 'conflict'], now() - interval '18 hours', 'https://www.ethiopia-insight.com/'),
  ('00000000-0000-0000-0001-000000000008', 'conflict', 'Lebanon-Israel Border: Hezbollah Exchange', 'Cross-border exchanges continue along Blue Line. IDF airstrikes on southern Lebanon. Hezbollah rocket fire into northern Israel.', 'high', 'IL', 'Middle East', 33.2, 35.5, ARRAY['lebanon', 'israel', 'hezbollah', 'border'], now() - interval '5 hours', null)
ON CONFLICT (id) DO NOTHING;

-- Weather events
INSERT INTO public.global_events (id, type, title, summary, severity, country_id, region, lat, lng, tags, occurred_at) VALUES
  ('00000000-0000-0000-0002-000000000001', 'weather', 'Tropical Storm Approaching Philippines', 'Category 3 typhoon tracking toward Luzon. Evacuation orders issued for coastal provinces. Expected landfall in 48 hours.', 'high', 'PH', 'Asia', 14.5, 122.0, ARRAY['typhoon', 'philippines', 'evacuation', 'tropical-storm'], now() - interval '1 hour'),
  ('00000000-0000-0000-0002-000000000002', 'weather', 'Magnitude 6.4 Earthquake — Japan', 'Strong earthquake strikes off coast of Fukushima prefecture. Tsunami advisory issued. Minor damage reported in coastal areas.', 'high', 'JP', 'Asia', 37.5, 141.9, ARRAY['earthquake', 'japan', 'tsunami', 'fukushima'], now() - interval '30 minutes'),
  ('00000000-0000-0000-0002-000000000003', 'weather', 'Unprecedented Heat Wave — Southern Europe', 'Record temperatures exceeding 45°C across Spain, Portugal, and southern France. Wildfire risk at extreme level. Health emergency declared.', 'high', 'ES', 'Europe', 38.0, -3.7, ARRAY['heatwave', 'europe', 'wildfire', 'extreme-heat'], now() - interval '6 hours'),
  ('00000000-0000-0000-0004-000000000001', 'weather', 'Heavy Monsoon Flooding — Bangladesh', 'Brahmaputra river overflow displaces 2 million people in northern Bangladesh. Emergency relief operations underway.', 'critical', 'BD', 'Asia', 24.5, 89.8, ARRAY['flooding', 'bangladesh', 'monsoon', 'displacement'], now() - interval '4 hours')
ON CONFLICT (id) DO NOTHING;

-- News events
INSERT INTO public.global_events (id, type, title, summary, severity, country_id, region, lat, lng, tags, occurred_at, source_url) VALUES
  ('00000000-0000-0000-0003-000000000001', 'news', 'Fed Signals Rate Decision at Jackson Hole', 'Federal Reserve chair hints at potential rate adjustments based on employment data and inflation trajectory. Markets react positively.', 'moderate', 'US', 'Americas', 43.5, -110.8, ARRAY['federal-reserve', 'interest-rates', 'monetary-policy', 'economy'], now() - interval '2 hours', 'https://www.bloomberg.com/'),
  ('00000000-0000-0000-0003-000000000002', 'news', 'BRICS Expansion: New Members Invited', 'BRICS summit concludes with invitation to five additional nations. Geopolitical shift toward multipolar economic framework accelerates.', 'moderate', 'ZA', 'Africa', -25.7, 28.2, ARRAY['brics', 'geopolitics', 'multipolar', 'trade'], now() - interval '12 hours', 'https://www.reuters.com/world/'),
  ('00000000-0000-0000-0003-000000000003', 'news', 'EU Approves New Sanctions Package on Russia', 'European Union agrees on 14th sanctions package targeting energy sector, banks, and dual-use goods. Russia vows countermeasures.', 'moderate', 'RU', 'Europe', 55.8, 37.6, ARRAY['sanctions', 'eu', 'russia', 'energy', 'economy'], now() - interval '8 hours', 'https://www.euractiv.com/'),
  ('00000000-0000-0000-0003-000000000004', 'news', 'Taiwan Strait: US Carrier Group Transit', 'USS Ronald Reagan carrier strike group conducts routine transit through Taiwan Strait. China PLA condemns as "provocative."', 'moderate', 'TW', 'Asia', 24.0, 120.5, ARRAY['taiwan', 'us-navy', 'south-china-sea', 'carrier'], now() - interval '6 hours', null),
  ('00000000-0000-0000-0003-000000000005', 'news', 'North Korea Launches Ballistic Missile Test', 'DPRK fires intermediate-range ballistic missile toward Sea of Japan. Japan issues J-Alert. UN Security Council emergency session called.', 'high', 'KP', 'Asia', 40.3, 127.5, ARRAY['north-korea', 'ballistic-missile', 'nuclear', 'un-security-council'], now() - interval '1 hour', 'https://www.38north.org/'),
  ('00000000-0000-0000-0003-000000000006', 'news', 'Iran Nuclear Programme: IAEA Findings', 'IAEA report indicates Iran has enriched uranium to 84% purity. Heightened concerns from P5+1. Diplomatic negotiations deadlocked.', 'high', 'IR', 'Middle East', 35.7, 51.4, ARRAY['iran', 'nuclear', 'iaea', 'enrichment', 'sanctions'], now() - interval '3 hours', 'https://www.iaea.org/'),
  ('00000000-0000-0000-0003-000000000007', 'news', 'Venezuela: Opposition Leader Arrested', 'Venezuelan authorities arrest key opposition figure ahead of elections. International community condemns move. Protests erupt in Caracas.', 'high', 'VE', 'Americas', 10.5, -66.9, ARRAY['venezuela', 'maduro', 'opposition', 'elections', 'human-rights'], now() - interval '5 hours', null),
  ('00000000-0000-0000-0003-000000000008', 'news', 'Pakistan-India Border Incident', 'Cross-border skirmish reported along Line of Control in Kashmir. Both sides exchange artillery fire. Diplomatic channels activated.', 'high', 'PK', 'Asia', 33.6, 74.0, ARRAY['pakistan', 'india', 'kashmir', 'loc', 'border'], now() - interval '7 hours', null)
ON CONFLICT (id) DO NOTHING;

-- Political/economic events
INSERT INTO public.global_events (id, type, title, summary, severity, country_id, region, lat, lng, tags, occurred_at) VALUES
  ('00000000-0000-0000-0005-000000000001', 'political', 'Turkey: Currency Crisis Deepens', 'Turkish lira hits new historic low against USD. Central bank emergency measures insufficient. IMF consultation discussions begin.', 'high', 'TR', 'Europe', 39.0, 35.2, ARRAY['turkey', 'lira', 'currency-crisis', 'inflation', 'imf'], now() - interval '3 hours'),
  ('00000000-0000-0000-0005-000000000002', 'market', 'Oil Markets: OPEC+ Production Cut Extension', 'OPEC+ agrees to extend voluntary production cuts through Q2. Saudi Arabia leads coalition. WTI crude rises 3.2%.', 'moderate', 'SA', 'Middle East', 24.7, 46.7, ARRAY['opec', 'oil', 'production-cut', 'energy', 'commodity'], now() - interval '4 hours'),
  ('00000000-0000-0000-0005-000000000003', 'political', 'Mexico: Cartel Violence Escalates in Sinaloa', 'Intra-cartel conflict between Sinaloa factions results in 40+ casualties. Mexican army deploys additional forces.', 'high', 'MX', 'Americas', 24.8, -107.4, ARRAY['mexico', 'sinaloa', 'cartel', 'violence', 'security'], now() - interval '10 hours'),
  ('00000000-0000-0000-0005-000000000004', 'market', 'Bitcoin ETF Inflows Hit New Record', 'Spot Bitcoin ETF daily inflows reach $1.2B. BTC approaches resistance level at $72k. Institutional adoption accelerating.', 'low', 'US', 'Americas', 37.1, -95.7, ARRAY['bitcoin', 'etf', 'institutional', 'crypto', 'sec'], now() - interval '2 hours')
ON CONFLICT (id) DO NOTHING;
